...
Those who would like to go further and beyond, we have a premium version of [Min Max Default Quantity for WooCommerce Pro](https://wpfactory.com/item/product-quantity-for-woocommerce/?utm_source=wporg&utm_medium=organic&utm_campaign=readme) plugin.
...
= 5.4.5 - 17/09/2026 =
* Fix - General - Disabled archive quantity inputs when the plugin is disabled.
* Fix - Min Quantity - Fixed incorrect quantity step sequence on the product page when the product's minimum quantity was already met by items already in the cart.
* WC tested up to: 11.1.
* Tested up to: 7.1.

= 5.4.4 - 02/07/2026 =
* Fix - Quantity Dropdown - Fixed dropdown on variable products.
* WC tested up to: 10.9.

= 5.4.3 - 17/06/2026 =
* Fix - Price Unit - Move "Allow price unit on category level" to free version.
* Fix - Price Unit - "Allow price unit on category level" was not overriding the General Price Unit option.
...
= 5.2.8 - 17/04/2026 =
* Fix - Fixed `%cart_total_quantity%` and `%item_quantity%` placeholders that were still showing total quantity in cart combined with quantity added to cart.
* Fix - Max Qty - Per Product was not overwriting the All Products option.
* Fix - Max Qty - Precedence between "All products" option and Per product option were not working properly.

= 5.2.7 - 15/04/2026 =
* Fix - Fixed `%cart_total_quantity%` and `%item_quantity%` placeholders that were showing total quantity in cart combined with quantity added to cart.
* WC tested up to: 10.7.

= 5.2.6 - 10/04/2026 =
* Fix - Max qty - Fixed per product option on variations.
* Fix - Fixed Add to cart validation when combined with Max Qty > Per Product.

= 5.2.5 - 27/03/2026 =
* Fix - Fixed Nonce caching for AJAX price updates.

= 5.2.4 - 16/03/2026 =
* Dev - Improved deploy mechanism.
* Fix - Fixed variable step quantity.
...
= 5.2.0 - 30/09/2025 =
* Dev - Minimum Qty - Added option to hide quantity input on loop if stock quantity matches minimum.

= 5.1.9 - 29/09/2025 =
* Dev - Minimum Qty - Added option to hide quantity input on product page if stock quantity matches minimum.
* Dev - Minimum Qty - Added option to hide quantity input on cart if stock quantity matches minimum.
...
* Dev - Total Price by Quantity - Added option to replace variation price if position is set to "Instead of the price".

= 5.1.6 - 12/08/2025 =
* Fix - Total price by quantity - Price was not showing properly.
* Dev - Total price by quantity - Code refactoring.
...
= 5.1.0 - 27/05/2025 =
* Fix - Minimum Quantity - Fixed Per product on free version.
...
* Dev - Changed 'woocommerce_quantity_input_args' priority to `PHP_INT_MAX - 100` to allow 3rd party customization.
...
Recently introduced to free users, this is now available in Free version as well as the [Pro version](https://wpfactory.com/item/product-quantity-for-woocommerce/?utm_source=wporg&utm_medium=desc&utm_campaign=freeversion) with a lot more features.
