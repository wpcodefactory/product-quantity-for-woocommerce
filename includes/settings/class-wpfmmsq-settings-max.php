...
if ( ! class_exists( 'WPFMMSQ_Settings_Max' ) ) :

	class WPFMMSQ_Settings_Max extends WPFMMSQ_Settings_Section {
		...
		function get_settings() {
			return array(
				...
				array(
					...
					'id'      => 'wpfmmsq_max_section_enabled',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
				...
				The Message field will allow you to customize the notification message on wrong quantities', 'product-quantity-for-woocommerce' ),
					'id'    => 'wpfmmsq_max_cart_total_quantity_options',
				),
				array(
					...
					'id'                => 'wpfmmsq_max_cart_total_quantity',
					'default'           => 0,
					'type'              => 'number',
				...
				array(
					...
					'id'          => 'wpfmmsq_max_cart_total_message',
				...
				array(
					...
					'id'    => 'wpfmmsq_max_per_item_quantity_options',
				),
				array(
					...
					'id'                => 'wpfmmsq_max_per_item_quantity',
					'default'           => 0,
					'type'              => 'number',
					'custom_attributes' => array( 'min' => 0, 'step' => $this->get_qty_step_settings() ),
					'alg_empty_value'   => 0,
				...
				array(
					...
					'id'       => 'wpfmmsq_max_per_item_quantity_per_product',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
					...
					'id'          => 'wpfmmsq_max_per_item_message',
				...
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_max_cat_cart_total_quantity_options',
				),
				array(
					...
					'id'    => 'wpfmmsq_max_per_cat_item_quantity_options',
				),
				array(
					...
					'id'                => 'wpfmmsq_max_per_cat_item_quantity_per_product',
					'type'              => 'checkbox',
				...
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_max_per_attribute_quantity_options',
				),
				array(
					...
					'id'    => 'wpfmmsq_max_per_attribute_item_quantity_options',
				),
				array(
					...
					'desc_tip'          => __( 'This will add meta box to each attribute edit page.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per attribute quantity options.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_max_per_attribute_item_quantity',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'       => 'wpfmmsq_max_per_attribute_selected',
					'default'  => array(),
					'type'     => 'multiselect',
					'class'    => 'chosen_select',
				...
				array(
					...
					'id'          => 'wpfmmsq_max_per_attribute_message',
...
return new WPFMMSQ_Settings_Max();
