...
if ( ! class_exists( 'WPFMMSQ_Settings_Step' ) ) :

	class WPFMMSQ_Settings_Step extends WPFMMSQ_Settings_Section {
		...
		function get_settings() {
			return array(
				...
				array(
					...
					'id'      => 'wpfmmsq_step_section_enabled',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
				...
				array(
					...
					'id'    => 'wpfmmsq_step_cart_total_quantity_options',
				),
				array(
					...
					'id'                => 'wpfmmsq_step_cart_total_quantity',
					'default'           => 0,
					'type'              => 'number',
				...
				array(
					...
					'id'          => 'wpfmmsq_step_cart_total_message',
				...
				array(
					...
					'id'    => 'wpfmmsq_step_per_item_options',
				),
				array(
				...
				array(
					...
					'id'       => 'wpfmmsq_step_per_product_enabled',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
				...
				array(
					...
					'id'                => 'wpfmmsq_step_per_item_quantity_per_product_less2x',
					'default'           => 'no',
					'type'              => 'checkbox',
				...
				array(
					...
					'desc_tip'          => __( 'Allow adding all remaining quantities to the cart after the last multiple of the step value. (Simple product and non-decimal step values are recommended. For now, only classic cart supported).', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per category quantity options.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_step_per_item_quantity_allow_all_remaining',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				...
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_step_cat_cart_total_quantity_options',
				),
				array(
					...
					'id'    => 'wpfmmsq_step_per_cat_item_quantity_options',
				),
				array(
					...
					'desc_tip'          => __( 'This will add meta box to each category edit page.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per category quantity options.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_step_per_cat_item_quantity_per_product',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				...
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_step_per_attribute_quantity_options',
				),
				array(
					...
					'id'    => 'wpfmmsq_step_per_attribute_item_quantity_options',
				),
				array(
					...
					'desc_tip'          => __( 'This will add meta box to each attribute edit page.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per attribute quantity options.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_step_per_attribute_item_quantity',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'       => 'wpfmmsq_step_per_attribute_selected',
					'default'  => array(),
					'type'     => 'multiselect',
					'class'    => 'chosen_select',
				...
				array(
					...
					'id'          => 'wpfmmsq_step_per_attribute_message',
...
return new WPFMMSQ_Settings_Step();
