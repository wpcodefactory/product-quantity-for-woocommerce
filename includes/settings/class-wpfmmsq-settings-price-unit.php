...
if ( ! class_exists( 'WPFMMSQ_Settings_Price_Unit' ) ) :

	class WPFMMSQ_Settings_Price_Unit extends WPFMMSQ_Settings_Section {
		...
		function get_settings() {
			return array(
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_qty_price_unit_options',
				),
				array(
					...
					'id'      => 'wpfmmsq_qty_price_unit_enabled',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					...
					'id'       => 'wpfmmsq_qty_price_unit_category_enabled',
					'default'  => 'no',
					'type'     => 'checkbox',
				...
				array(
					...
					'id'                => 'wpfmmsq_qty_price_unit_product_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'desc_tip'          => __( 'Show Price Unit on archive/category/shop pages (you need to enable quantity on archive pages from General tab).', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use unit on category/ shop/ archive pages.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_qty_price_unit_show_archive_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				...
				array(
					...
					'desc_tip'          => __( 'Enable this option to display the unit for that product in the email order item.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to show unit on email order item.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_qty_price_unit_email_order_item_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
...
return new WPFMMSQ_Settings_Price_Unit();
