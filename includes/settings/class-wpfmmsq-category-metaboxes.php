...
class WPFMMSQ_Category_Metaboxes {
	...
	public function pq_taxonomy_add_custom_meta_field() {
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_min]"><?php esc_html_e( 'Minimum quantity (grouped for this category)', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ) ); ?></label>
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_min_all_product]"><?php esc_html_e( 'Minimum quantity for all product (apply to all products in this category)', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ) ); ?></label>
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_max]"><?php esc_html_e( 'Maximum quantity (grouped for this category)', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ) ); ?></label>
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_max_all_product]"><?php esc_html_e( 'Maximum quantity for all product (apply to all products in this category)', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ) ); ?></label>
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_step]"><?php esc_html_e( 'Quantity step', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ) ); ?></label>
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_default]"><?php esc_html_e( 'Quantity default', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ) ); ?></label>
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_exact_qty_allowed]"><?php esc_html_e( 'Exact quantity allowed (grouped for this category)', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( sprintf( __( 'Allowed quantities as comma separated list, e.g.: %s.', 'product-quantity-for-woocommerce' ), '<em>3,7,9</em>' ), true ) ); ?></label>
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_exact_qty_allowed_all_product]"><?php esc_html_e( 'Exact quantity allowed for all product (apply to all products in this category)', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( sprintf( __( 'Allowed quantities as comma separated list, e.g.: %s.', 'product-quantity-for-woocommerce' ), '<em>3,7,9</em>' ), true ) ); ?></label>
		...
		<div class="form-field">
			<label for="term_meta[alg_wc_pq_exact_qty_disallowed]"><?php esc_html_e( 'Exact quantity disallowed', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( sprintf( __( 'Disallowed quantities as comma separated list, e.g.: %s.', 'product-quantity-for-woocommerce' ), '<em>3,7,9</em>' ), true ) ); ?></label>
	...
	public function pq_taxonomy_edit_custom_meta_field($term) {
	   ...
	   <?php if ( $this->is_section_enabled['min'] ) { ?>
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_min]"><?php esc_html_e( 'Minimum quantity (grouped for this category)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_min_all_product]"><?php esc_html_e( 'Minimum quantity for all product (apply to all products in this category)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
		...
		<?php if ( $this->is_section_enabled['max'] ) { ?>
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_max]"><?php esc_html_e( 'Maximum quantity (grouped for this category)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_max_all_product]"><?php esc_html_e( 'Maximum quantity for all product (apply to all products in this category)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
		...
		<?php if ( $this->is_section_enabled['step'] ) { ?>
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_step]"><?php esc_html_e( 'Quantity step', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
		...
		<?php if ( $this->is_section_enabled['default'] ) { ?>
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_default]"><?php esc_html_e( 'Quantity default', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
		...
		<?php if ( $this->is_section_enabled['exact_qty_allowed'] ) { ?>
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_exact_qty_allowed]"><?php esc_html_e( 'Exact quantity allowed (grouped for this category)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( sprintf( __( 'Allowed quantities as comma separated list, e.g.: %s.', 'product-quantity-for-woocommerce' ), '<em>3,7,9</em>' ), true ) ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_exact_qty_allowed_all_product]"><?php esc_html_e( 'Exact quantity allowed for all product (apply to all products in this category)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( sprintf( __( 'Allowed quantities as comma separated list, e.g.: %s.', 'product-quantity-for-woocommerce' ), '<em>3,7,9</em>' ), true ) ); ?></label></th>
			<td>
		...
		<?php /*if ( $this->is_section_enabled['exact_qty_disallowed'] ) { ?>
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_exact_qty_disallowed]"><?php esc_html_e( 'Exact quantity disallowed', 'product-quantity-for-woocommerce' ); ?> <?php echo wp_kses_post( wc_help_tip( sprintf( __( 'Disallowed quantities as comma separated list, e.g.: %s.', 'product-quantity-for-woocommerce' ), '<em>3,7,9</em>' ), true ) ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_category_unit_singular]"><?php esc_html_e( 'Unit label template: Singular', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_category_unit_plural]"><?php esc_html_e( 'Unit label template: Plural', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_category_price_unit]"><?php esc_html_e( 'Price Unit', 'product-quantity-for-woocommerce' ); ?> <?php //echo wp_kses_post( wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ) ); ?></label></th>
			<td>
				<?php 
					$catUnit = '';
					$catUnit = esc_attr( $term_meta['alg_wc_pq_category_price_unit'] ) ? esc_attr( $term_meta['alg_wc_pq_category_price_unit'] ) : '';
				?>
				<input type="text"  name="term_meta[alg_wc_pq_category_price_unit]" id="term_meta[alg_wc_pq_category_price_unit]" value="<?php echo esc_attr( $catUnit ); ?>">
