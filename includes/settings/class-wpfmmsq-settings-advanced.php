...
if ( ! class_exists( 'WPFMMSQ_Settings_Advanced' ) ) :

	class WPFMMSQ_Settings_Advanced extends WPFMMSQ_Settings_Section {
		...
		function get_user_roles() {
			global $wp_roles;
			$user_roles = array_merge( array( 'guest' => array( 'name' => __( 'Guest', 'product-quantity-for-woocommerce' ), 'capabilities' => array() ) ),
		...
		function get_settings() {
			return array(
				...
				array(
					...
					'desc'    => __( 'Min/max quantity', 'product-quantity-for-woocommerce' ),
					'id'      => 'wpfmmsq_force_js_check_min_max_periodically',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					'desc'    => __( 'Quantity step', 'product-quantity-for-woocommerce' ),
					'id'      => 'wpfmmsq_force_js_check_step_periodically',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					'desc'              => __( 'Period (ms)', 'product-quantity-for-woocommerce' ),
					'id'                => 'wpfmmsq_force_js_check_period_ms',
					'default'           => 1000,
					'type'              => 'number',
				...
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_advanced_order_item_meta_options',
				),
				array(
					...
					'id'      => 'wpfmmsq_save_qty_in_order_item_meta',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					'desc'    => __( 'Meta key', 'product-quantity-for-woocommerce' ),
					'id'      => 'wpfmmsq_save_qty_in_order_item_meta_key',
					'default' => '_wpfmmsq_qty',
					'type'    => 'text',
					'css'     => 'width:100%;',
				),
				array(
				...
				array(
					...
					'id'       => 'wpfmmsq_round_on_add_to_cart',
					'default'  => 'no',
					'type'     => 'select',
					'class'    => 'chosen_select',
					'options'  => array(
				...
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_cart_advanced_options',
				),
				array(
					...
					'id'      => 'wpfmmsq_disable_by_order_per_user',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
				...
				array(
					...
					'id'                => 'wpfmmsq_disable_by_category',
					'default'           => array(),
					'type'              => 'multiselect',
					'class'             => 'chosen_select',
				...
				array(
					...
					'desc'     => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'       => 'wpfmmsq_enable_exclude_role_specofic',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				...
				array(
					...
					'id'                => 'wpfmmsq_required_user_roles',
					'default'           => array(),
					'type'              => 'multiselect',
					'class'             => 'chosen_select',
					'options'           => $this->get_user_roles(),
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
					'desc'              => apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use this feature.',
				...
				array(
					...
					'desc_tip'          => __( 'Will not effect to selected user roles.', 'product-quantity-for-woocommerce' ) . ' ' .
					                       __( 'Leave blank all user roles.', 'product-quantity-for-woocommerce' ),
					'id'                => 'wpfmmsq_non_required_user_roles',
					'default'           => array(),
					'type'              => 'multiselect',
					'class'             => 'chosen_select',
					'options'           => $this->get_user_roles(),
				...
				array(
					...
					'desc'     => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'       => 'wpfmmsq_validate_on_checkout',
					'default'  => 'yes',
					'type'     => 'checkbox',
				),
				array(
				...
				array(
					...
					'desc'     => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'       => 'wpfmmsq_replace_woocommerce_quantity_field',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
					...
					'desc'     => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'       => 'wpfmmsq_advance_wc_block_api',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				...
				array(
					...
					'desc'     => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'       => 'wpfmmsq_advance_wpc_product_bundle',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
...
return new WPFMMSQ_Settings_Advanced();
