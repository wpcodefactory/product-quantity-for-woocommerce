...
if ( ! class_exists( 'WPFMMSQ_Settings_Dropdown' ) ) :

	class WPFMMSQ_Settings_Dropdown extends WPFMMSQ_Settings_Section {
		...
		function get_settings() {
			return array(
				...
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_qty_dropdown_options',
				...
				array(
					...
					'id'      => 'wpfmmsq_qty_dropdown_search_filter',
					'default' => 'no',
					'type'    => 'checkbox',
				...
				array(
					...
					'id'                => 'wpfmmsq_qty_dropdown_max_value_fallback',
					'default'           => 0,
					'type'              => 'number',
				...
				array(
					...
					'id'       => 'wpfmmsq_qty_dropdown_thousand_separator_enabled',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				...
				array(
					...
					'id'                => 'wpfmmsq_qty_dropdown_thousand_separator',
					'default'           => ',',
					'type'              => 'text',
					'custom_attributes' => array( 'min' => 0, 'step' => $this->get_qty_step_settings() ),
					'css'               => 'width:50px;',
				...
				array(
					...
					'id'      => 'wpfmmsq_qty_dropdown_disable_dropdown_on_cart',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
				...
				You can also define this label on product level by enabling "Labels per product"', 'product-quantity-for-woocommerce' ),
					'id'    => 'wpfmmsq_qty_dropdown_label_options',
				),
				array(
					...
					'id'      => 'wpfmmsq_qty_dropdown_label_template_singular',
					'default' => '%qty%',
					'type'    => 'text',
					'css'     => 'width:100%;',
				),
				array(
					...
					'desc'    => $this->message_replaced_values( array( '%qty%', '%price%', '%item_price%' ) ) . ' ' .
					             sprintf( __( 'For example try %s', 'product-quantity-for-woocommerce' ), '<code>%qty% for %item_price% = %price%</code>' ),
					'id'      => 'wpfmmsq_qty_dropdown_label_template_plural',
					'default' => '%qty%',
					'type'    => 'text',
					'css'     => 'width:100%;',
				),
				array(
					...
					'desc_tip'          => __( 'This will add "Product Quantity" meta box to each product\'s edit page.', 'product-quantity-for-woocommerce' ) . apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per product.',
								'<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_qty_dropdown_label_template_is_per_product',
					'default'           => 'no',
					'type'              => 'checkbox',
				...
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_qty_dropdown_qty_archive_options',
				),
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_qty_dropdown_per_category_options',
				),
				array(
					'title'             => __( 'Enable per category', 'product-quantity-for-woocommerce' ),
					'desc'              => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'desc_tip'          => apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per category.',
							'<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_qty_dropdown_enable_per_category',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'                => 'wpfmmsq_qty_dropdown_per_category_categories',
				...
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_qty_dropdown_template_options',
				),
				array(
					...
					'id'          => 'wpfmmsq_qty_dropdown_template_before',
					'default'     => '',
					'type'        => 'textarea',
				...
				array(
					...
					'desc_tip'    => __( 'Will be outputted on frontend after the quantity dropdown box.', 'product-quantity-for-woocommerce' ) . ' ' .
					                 __( 'You can use HTML and/or shortcodes here.', 'product-quantity-for-woocommerce' ) . ' ' .
					                 __( 'Ignored if empty.', 'product-quantity-for-woocommerce' ),
					'id'          => 'wpfmmsq_qty_dropdown_template_after',
					'default'     => '',
					'type'        => 'textarea',
					'css'         => 'width:100%;min-height:100px;',
					'wpfmmsq_raw' => true,
				...
				array(
					...
					'id'    => 'wpfmmsq_qty_dropdown_qty_archive_options_title',
				),
				array(
					'title'             => __( 'Enable dropdown on archive pages', 'product-quantity-for-woocommerce' ),
					'desc'              => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'desc_tip'          => apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use dropdown on archive pages.',
							'<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_qty_dropdown_qty_archive_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
		...
		function get_product_categories() {
			...
			if ( $product_categories ) {
				foreach ( $product_categories as $key => $category ) {
					$return_fields[ $category->term_id ] = $category->name;
				}
			}
...
return new WPFMMSQ_Settings_Dropdown();
