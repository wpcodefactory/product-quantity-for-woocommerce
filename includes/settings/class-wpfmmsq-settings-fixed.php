...
if ( ! class_exists( 'WPFMMSQ_Settings_Fixed' ) ) :

	class WPFMMSQ_Settings_Fixed extends WPFMMSQ_Settings_Section {
		...
		function get_settings() {
			$fields = array(
				...
				Functions here follow the same logic in minimum/maximum quantities on cart/all products/product level quantities.', 'product-quantity-for-woocommerce' ),
					'id'    => 'wpfmmsq_exact_qty_allowed_options',
				),
				array(
					...
					'id'      => 'wpfmmsq_exact_qty_allowed_section_enabled',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
				...
				array(
					...
					'desc_tip'          => __( 'This will add meta box to each product\'s edit page.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to set per product allowed quantities.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_exact_qty_allowed_per_product_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
				...
				array(
					...
					'id'          => 'wpfmmsq_exact_qty_allowed_message',
				...
				array(
					...
					'desc_tip'          => __( 'Enabling this will create two new fields in all categories pages you have, one to set a fixed quantity for all products (instead of filling it one by one), and one for specifying a fixed quantity for all products <strong>combined</strong> in the cart.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per category quantity options.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_exact_qty_allowed_per_cat_item_quantity_per_product',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'          => 'wpfmmsq_exact_qty_allowed_cat_message',
				...
				array(
					...
					'desc_tip'          => __( 'Enabling this option will create a field for fixed quantities per attributes that are selected in the field below instead of enabling it to all attributes at once.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per category quantity options.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_exact_qty_allowed_per_attribute_item_quantity',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'       => 'wpfmmsq_exact_qty_allowed_per_attributes_selected',
					'default'  => array(),
					'type'     => 'multiselect',
					'class'    => 'chosen_select',
			...
			$fields2 = array(
				array(
					...
					'id'          => 'wpfmmsq_exact_qty_allowed_attribute_item_message',
				...
				array(
					...
					'id'                => 'wpfmmsq_exact_subset_sum_allowed_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				...
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_exact_qty_disallowed_options',
				),
				array(
					'title'   => __( 'Disallowed quantity', 'product-quantity-for-woocommerce' ),
					'desc'    => '<strong>' . __( 'Enable section', 'product-quantity-for-woocommerce' ) . '</strong>',
					'id'      => 'wpfmmsq_exact_qty_disallowed_section_enabled',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					...
					'desc_tip' => __( 'Ignored if empty.', 'product-quantity-for-woocommerce' ),
					'id'       => 'wpfmmsq_exact_qty_disallowed',
					'default'  => '',
					'type'     => 'text',
					'css'      => 'width:100%;',
				),
				array(
					...
					'desc'              => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'desc_tip'          => __( 'This will add meta box to each product\'s edit page.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to set per product disallowed quantities.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_exact_qty_disallowed_per_product_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'          => 'wpfmmsq_exact_qty_disallowed_message',
				...
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_exact_min_cart_total_quantity_options',
				),
				array(
					'title'             => __( 'Cart fixed quantity', 'product-quantity-for-woocommerce' ),
					'desc'              => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'desc_tip'          => __( '', 'product-quantity-for-woocommerce' ),
					'id'                => 'wpfmmsq_exact_cart_total_quantity_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'                => 'wpfmmsq_exact_cart_total_quantity',
					'default'           => 0,
					'type'              => 'text',
				...
				array(
					...
					'id'          => 'wpfmmsq_exact_cart_total_message',
...
return new WPFMMSQ_Settings_Fixed();
