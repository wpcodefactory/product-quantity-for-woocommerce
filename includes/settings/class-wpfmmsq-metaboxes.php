...
class WPFMMSQ_Metaboxes {
	...
	function __construct() {
		if ( 'yes' === get_option( 'alg_wc_pq_enabled', 'yes' ) ) {
			$step_per_product_enabled = apply_filters( 'wpfmmsq_quantity_step_per_product', get_option( 'alg_wc_pq_step_per_product_enabled', 'no' ) );
			$this->is_section_enabled = array(
				...
				'allow_selling_below_stock'    => ( 'yes' === get_option( 'alg_wc_pq_min_per_item_quantity_per_product_allow_selling_below_stock', 'no' ) &&
					'yes' === get_option( 'alg_wc_pq_min_section_enabled', 'no' ) ) && 'yes' === apply_filters( 'wpfmmsq_per_item_qty_per_product', 'no', 'min' ),
			);
			if (
