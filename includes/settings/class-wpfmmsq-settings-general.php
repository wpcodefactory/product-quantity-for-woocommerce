...
if ( ! class_exists( 'WPFMMSQ_Settings_General' ) ) :

	class WPFMMSQ_Settings_General extends WPFMMSQ_Settings_Section {
		...
		function get_settings() {
			...
			$general_settings = array(
				...
				array(
					...
					'id'       => 'wpfmmsq_decimal_quantities_enabled',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
					...
					'id'       => 'wpfmmsq_decimal_quantities_admin_order_enabled',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
					...
					'id'       => 'wpfmmsq_all_sold_individually_enabled',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
					...
					'id'       => 'wpfmmsq_force_cart_min_enabled',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
				...
				For most stores, the "Validate and add notices" is recommended.', 'product-quantity-for-woocommerce' ),
					'id'       => 'wpfmmsq_add_to_cart_validation',
					'default'  => 'disable',
					'type'     => 'select',
				...
				array(
					...
					'id'       => 'wpfmmsq_add_to_cart_validation_step_auto_correct',
					'default'  => 'round',
					'type'     => 'select',
					'class'    => 'wc-enhanced-select',
					'options'  => array(
				...
				array(
					...
					'desc'     => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'       => 'wpfmmsq_cart_notice_enabled',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
					'desc'    => __( 'Cart notice type', 'product-quantity-for-woocommerce' ),
					'id'      => 'wpfmmsq_cart_notice_type',
					'default' => 'notice',
					'type'    => 'select',
					'class'   => 'wc-enhanced-select',
					'options' => array(
				...
				array(
					...
					'id'       => 'wpfmmsq_stop_from_seeing_checkout',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
				...
				array(
					...
					'id'       => 'wpfmmsq_buy_all_stock_button_class',
				...
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_general_qty_archive_options_title',
				),
				array(
					...
					'desc_tip'          => __( 'Allow customers to select quantities and add to cart from shop/archive/categories pages, <strong>this works only on simple products.</strong>', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use quantity box on archive page.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_add_quantity_archive_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
				...
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_general_qty_archive_options',
				),
				array(
				...
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_qty_variable_products_options',
				),
				array(
...
return new WPFMMSQ_Settings_General();
