	...
	public function pq_taxonomy_edit_custom_meta_field($term) {
	   ...
	   ?>
		<?php if ( $this->is_section_enabled['min'] && $this->is_field_allowed($taxonomy, $alg_wc_pq_min_per_attribute_selected) ) { ?>
			<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_min]"><?php esc_html_e( 'Minimum quantity (grouped for this attribute item)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ); ?></label></th>
				<td>
			...
			<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_min_all_product]"><?php esc_html_e( 'Minimum quantity for all product (apply to all products in this attribute item)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ); ?></label></th>
				<td>
		...
		<?php if ( $this->is_section_enabled['max'] && $this->is_field_allowed($taxonomy, $alg_wc_pq_max_per_attribute_selected) ) { ?>
			<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_max]"><?php esc_html_e( 'Maximum quantity (grouped for this attribute item)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ); ?></label></th>
				<td>
			...
			<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_max_all_product]"><?php esc_html_e( 'Maximum quantity for all product (apply to all products in this attribute item)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ); ?></label></th>
				<td>
		...
		<?php if ( $this->is_section_enabled['step'] && $this->is_field_allowed($taxonomy, $alg_wc_pq_step_per_attribute_selected) ) { ?>
			<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_step]"><?php esc_html_e( 'Step quantity', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ); ?></label></th>
				<td>
			...
			<?php /*
			<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_step_all_product]"><?php esc_html_e( 'Step quantity for all product', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( __( 'Set 0 to use global settings. Set -1 to disable.', 'product-quantity-for-woocommerce' ), true ); ?></label></th>
				<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_exact_qty_allowed]"><?php esc_html_e( 'Exact quantity allowed (grouped for this attribute item)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( sprintf( __( 'Allowed quantities as comma separated list, e.g.: %s.', 'product-quantity-for-woocommerce' ), '<em>3,7,9</em>' ), true ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_exact_qty_allowed_all_product]"><?php esc_html_e( 'Exact quantity allowed for all product (apply to all products in this attribute item)', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( sprintf( __( 'Allowed quantities as comma separated list, e.g.: %s.', 'product-quantity-for-woocommerce' ), '<em>3,7,9</em>' ), true ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_price_by_qty_attribute_unit_singular]"><?php esc_html_e( 'Unit label template: Singular', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ); ?></label></th>
			<td>
		...
		<tr class="form-field">
		<th scope="row" valign="top"><label for="term_meta[alg_wc_pq_price_by_qty_attribute_unit_plural]"><?php esc_html_e( 'Unit label template: Plural', 'product-quantity-for-woocommerce' ); ?> <?php //echo wc_help_tip( __( 'Set 0 to use global settings.', 'product-quantity-for-woocommerce' ), true ); ?></label></th>
			<td>
