...
if ( ! class_exists( 'WPFMMSQ_Settings_Price_By_Qty' ) ) :

	class WPFMMSQ_Settings_Price_By_Qty extends WPFMMSQ_Settings_Section {
		...
		function get_settings() {
			return array(
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_qty_price_by_qty_options',
				),
				array(
					...
					'id'      => 'wpfmmsq_qty_price_by_qty_enabled',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					...
					'id'      => 'wpfmmsq_qty_price_by_qty_enabled_variable',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					...
					'desc'              => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'                => 'wpfmmsq_qty_price_by_qty_unit_input_enabled',
					'desc_tip'          => __( 'This will create two new fields on any product edit page, for singular & plural units to be used for that product.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use unit on product level.',
				...
				array(
					...
					'desc'              => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'                => 'wpfmmsq_qty_price_by_cat_qty_unit_input_enabled',
					'desc_tip'          => __( 'This will create two new fields on any category edit page, for singular & plural units to be used for all products under that category.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use unit on category level.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				...
				array(
					...
					'desc_tip'          => __( 'This will add meta box to each attribute edit page.', 'product-quantity-for-woocommerce' ) .
					                       apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per attribute quantity options.',
							                       '<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_qty_price_by_attribute_qty_unit_input_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'       => 'wpfmmsq_qty_price_by_attribute_qty_unit_input_selected',
					'default'  => array(),
					'type'     => 'multiselect',
					'class'    => 'chosen_select',
				...
				array(
					...
					'desc'        => '',
					'id'          => 'wpfmmsq_qty_price_by_qty_unit_singular',
					'type'        => 'text',
					'wpfmmsq_raw' => true,
				),
				array(
					...
					'desc_tip'    => __( 'This field will be used if no product/category units are defined', 'product-quantity-for-woocommerce' ),
					'desc'        => '',
					'id'          => 'wpfmmsq_qty_price_by_qty_unit_plural',
					'type'        => 'text',
					'wpfmmsq_raw' => true,
				),
				array(
				...
				array(
					...
					'id'       => 'wpfmmsq_qty_price_by_qty_position',
				...
				array(
					...
					'id'      => 'wpfmmsq_qty_price_by_qty_variation_price',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_qty_price_by_qty_qty_archive_options',
				),
				array(
					...
					'id'    => 'wpfmmsq_qty_price_by_qty_qty_archive_options_title',
				),
				array(
					'title'             => __( 'Enable Price by quantity on archive pages', 'product-quantity-for-woocommerce' ),
					'desc'              => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'desc_tip'          => apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use Price by quantity on archive pages.',
							'<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_qty_price_by_qty_qty_archive_enabled',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_price_by_qty_options_percategory',
				),
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_price_by_qty_per_category_options',
				),
				array(
					...
					'desc_tip'          => apply_filters( 'wpfmmsq_settings', '<br>' . sprintf( 'You will need %s to use per category.',
							'<a target="_blank" href="https://wpfactory.com/item/product-quantity-for-woocommerce/">' . 'Product Quantity for WooCommerce Pro' . '</a>' ) ),
					'id'                => 'wpfmmsq_price_by_qty_enable_per_category',
					'default'           => 'no',
					'type'              => 'checkbox',
					'custom_attributes' => apply_filters( 'wpfmmsq_settings', array( 'disabled' => 'disabled' ) ),
				),
				array(
					...
					'id'                => 'wpfmmsq_price_by_qty_per_category_categories',
...
return new WPFMMSQ_Settings_Price_By_Qty();
