...
if ( ! class_exists( 'WPFMMSQ_Settings_Quantity_Info' ) ) :

	class WPFMMSQ_Settings_Quantity_Info extends WPFMMSQ_Settings_Section {
		...
		function get_settings() {
			$content_desc    = __( 'You can use HTML and/or shortcodes here.', 'product-quantity-for-woocommerce' ) . ' ' .
			                   sprintf( __( 'Available shortcodes: %s.', 'product-quantity-for-woocommerce' ), '<code>' . implode( '</code>, <code>', array(
					                   '[wpfmmsq_min_product_qty]',
					                   '[wpfmmsq_max_product_qty]',
					                   '[wpfmmsq_product_qty_step]',
			...
			return array(
				array(
					...
					'type'  => 'title',
					'id'    => 'wpfmmsq_qty_info_options',
					'desc'  => $content_desc,
				),
				array(
					'title'   => __( 'Single product page', 'product-quantity-for-woocommerce' ),
					'desc'    => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'      => 'wpfmmsq_qty_info_on_single_product',
					'default' => 'no',
					'type'    => 'checkbox',
				),

				array(
					'id'          => 'wpfmmsq_qty_info_on_single_product_content',
				...
				array(
					...
					'desc'    => __( 'Enable', 'product-quantity-for-woocommerce' ),
					'id'      => 'wpfmmsq_qty_info_on_loop',
					'default' => 'no',
					'type'    => 'checkbox',
				),
				array(
					'id'          => 'wpfmmsq_qty_info_on_loop_content',
					'default'     => $default_content,
					'type'        => 'textarea',
					'css'         => 'width:70%;min-height:100px;',
					'wpfmmsq_raw' => true,
				...
				array(
					'type' => 'sectionend',
					'id'   => 'wpfmmsq_qty_info_options_advance',
				),
				array(
					'title' => __( 'Advanced', 'product-quantity-for-woocommerce' ),
					'desc'  => __( '', 'product-quantity-for-woocommerce' ),
					'type'  => 'title',
					'id'    => 'wpfmmsq_qty_info_per_category_advance',
				),
				array(
					...
					'id'       => 'wpfmmsq_qty_info_on_single_product_custom_hook',
					'default'  => 'no',
					'type'     => 'checkbox',
				),
				array(
					...
					'id'       => 'wpfmmsq_qty_info_on_single_product_custom_hook_name',
					'default'  => '',
					'type'     => 'text'
				),
				array(
					...
					'id'       => 'wpfmmsq_qty_info_on_single_product_custom_hook_priority',
					'default'  => '',
					'type'     => 'text'
				),
				array(
...
return new WPFMMSQ_Settings_Quantity_Info();
